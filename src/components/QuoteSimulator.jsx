        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            >
                ...
                {(step > 0 && step <= totalSteps) && (
                    <div className="md:w-1/3 bg-slate-50 dark:bg-slate-900/50 p-6 md:p-8 flex flex-col justify-between border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-800">
                        <div>
                            ...
                            {currentQuestion.multi && (
                                <p className="text-sm text-primary-600 dark:text-primary-400 font-medium bg-primary-50 dark:bg-primary-500/10 inline-block px-3 py-1 rounded-full border border-primary-100 dark:border-transparent">
                ...
                <div className={`flex-1 flex flex-col relative ${step === 0 || step === 7 ? 'md:col-span-2' : ''}`}>
                    <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8" data-lenis-prevent>
                        <AnimatePresence mode="wait">
                                            ...
                                            >
                                                ...
                                                >
                                                    <div className="flex justify-between items-start mb-4">
                                                        <div className={`p-3 rounded-lg transition-colors ${isSelected ? 'bg-primary-500 text-white shadow-lg shadow-primary-500/30' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 group-hover:bg-slate-200 dark:group-hover:bg-slate-700 group-hover:text-slate-700 dark:group-hover:text-white'}`}>
                                                    ...
                                                    <h4 className={`font-bold text-lg mb-1 ${isSelected ? 'text-primary-700 dark:text-white' : 'text-slate-900 dark:text-slate-200'}`}>
                                                        {option.label}
                                                    </h4>
                            ...
                            {step === 7 && (
                                <motion.div
                                    ...
                                    className="h-full flex flex-col items-center justify-center text-center space-y-8"
                                >
                                    <div className="w-full max-w-sm bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 p-8 rounded-3xl relative overflow-hidden">
                                        ...
                                        <h3 className="text-slate-500 dark:text-slate-400 text-sm font-semibold uppercase tracking-wider mb-2">Estimation Finale</h3>
                                    ...
                                    <div className="max-w-md">
                                        <p className="text-sm text-yellow-600 dark:text-yellow-500/90 bg-yellow-50 dark:bg-yellow-500/10 p-4 rounded-xl border border-yellow-200 dark:border-yellow-500/20 mb-6">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                            <a
                                                href="#contact"
                                                onClick={onClose}
                                                className="px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold rounded-xl hover:bg-slate-800 dark:hover:bg-slate-200 transition-colors shadow-lg"
                                            >
                                                {simulator.result.cta}
                                            </a>
                                            <button
                                                onClick={() => setStep(0)}
                                                className="px-8 py-4 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white font-medium transition-colors"
                                            >
                                                Relancer
                                            </button>
                                        </div>
                    ...
                    {step > 0 && step <= totalSteps && (
                        <div className="p-6 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 flex justify-between items-center md:rounded-br-3xl">
                            <button
                                onClick={prevStep}
                                className="flex items-center gap-2 text-slate-500 hover:text-slate-900 dark:hover:text-white font-medium transition-colors px-4 py-2 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-lg"
                            >
